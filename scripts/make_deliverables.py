...
PLOT_EXPLANATIONS = {
    ...
    "deletion_rainfall_left_breakpoint.pdf": "Location-size plot of post-remap deletion calls placed by alignment-directed left breakpoint; the HTML report adds a minimum-support slider and point mouseovers.",
    "deletion_rainfall_right_breakpoint.pdf": "Location-size plot of post-remap deletion calls placed by alignment-directed right breakpoint; the HTML report adds a minimum-support slider and point mouseovers.",
    "deletion_rainfall_midpoint.pdf": "Location-size plot of post-remap deletion calls placed by circular deleted-interval midpoint; the HTML report adds a minimum-support slider and point mouseovers.",
...
TABLE_EXPLANATIONS = {
    ...
    "circular_chord_displayed_deletions.tsv": "Exact deletions included in the baseline circular chord PDFs after the rainfall display threshold and any configured count cap.",
    "circular_chord_interactive_deletions.tsv": "All exact deletions loaded into the interactive circular chord view after the rainfall support threshold but before any configured count cap.",
